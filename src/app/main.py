...
class CustomerData(BaseModel):
    ...
    # Regional and Operator features
    Governorate: str
...
demo = gr.Interface(
    ...
    inputs=[
        ...
        gr.Dropdown([
            ...
            "Tozeur", "Kebili"
        ], label="Governorate", value="Tunis"),
        gr.Dropdown(["Tunisie Telecom", "Ooredoo", "Orange"], label="Telecom Operator", value="Tunisie Telecom"),
    ],
