...
def main(args):
    ...
    mlruns_path = args.mlflow_uri or "file:./mlruns"
...
if __name__ == "__main__":
    ...
    p.add_argument("--input", type=str, required=True,
                   help="path to CSV (e.g., data/raw/Tunisian_Telco_Customer_Churn.csv)")
...
python scripts/run_pipeline.py \
    --input data/raw/Tunisian_Telco_Customer_Churn.csv \
    --target Churn
